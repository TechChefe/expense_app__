...
Η εφαρμογή αναπτύχθηκε ως εργασία εξαμήνου στο πλαίσιο του μαθήματος **Κινητός και Διάχυτος Υπολογισμός** του ΠΜΣ **Μηχανική Λογισμικού για Διαδικτυακές & Φορητές Εφαρμογές** του **Αριστοτελείου Πανεπιστημίου Θεσσαλονίκης**, ακαδημαϊκό έτος 2025–2026.
